/**
 * SOLE Voltaje - Scripts personalizados
 * Este archivo se carga automáticamente por Quartz
 */
...
(function() {
  ...
  // ================================
  // Sistema de cambio de idioma (i18n)
  // ================================
  ...
  function createLanguageSwitcher() {
    ...
    // Marcar como primera visita si es necesario (opcional)
    const isFirstVisit = !localStorage.getItem('voltaje-language-switch-seen');
    if (isFirstVisit) {
      button.classList.add('first-visit');
      localStorage.setItem('voltaje-language-switch-seen', 'true');
    }
  }
